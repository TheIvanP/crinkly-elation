...
config.read_file(open("dwh_secrets.cfg"))
...
#%% [markdown]
### create cluster
### [docs](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/redshift.html#Redshift.Client.create_cluster)
